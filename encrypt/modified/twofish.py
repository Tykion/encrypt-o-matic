...
# This is a modified twofish package because of it was outdated and didnt work with with python 3.13+.
# Moved from .venv because compiling decrypt.exe was a pain after all its just a .py file not a C package.
